...
class DeporteSerializer(serializers.ModelSerializer):
    """Serializer para catálogo de deportes."""
...
class PersonaSerializer(serializers.ModelSerializer):
    """Serializer para datos de identidad de personas."""
...
class PerfilOperativoSerializer(serializers.ModelSerializer):
    ...
    persona_nombre = serializers.ReadOnlyField(source="persona.nombre_completo")
...
# ============================================================================
# PROTOCOLO DE AUDITORÍA SERIALIZERS
# ============================================================================


class ProtocoloAuditoriaSerializer(serializers.ModelSerializer):
    """Serializer para umbrales de auditoría (singleton)."""

    updated_by_username = serializers.ReadOnlyField(source="updated_by.username")

    class Meta:
        model = ProtocoloAuditoria
        fields = "__all__"
        read_only_fields = ["id_protocolo", "updated_at", "updated_by"]
